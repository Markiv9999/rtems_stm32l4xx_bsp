...
void ov5640_configure_jpeg_QXGA(void) {
  write_i2c(0x38, 0x20, 0x40);
  write_i2c(0x38, 0x21, 0x26);
  write_i2c(0x38, 0x14, 0x11);
  write_i2c(0x38, 0x15, 0x11);
  write_i2c(0x38, 0x03, 0x00);
  write_i2c(0x38, 0x07, 0x9f);
  write_i2c(0x38, 0x08, 0x0a);
  write_i2c(0x38, 0x09, 0x20);
  write_i2c(0x38, 0x0a, 0x07);
  write_i2c(0x38, 0x0b, 0x98);
  write_i2c(0x38, 0x0c, 0x0b);
  write_i2c(0x38, 0x0d, 0x1c);
  write_i2c(0x38, 0x0e, 0x07);
  write_i2c(0x38, 0x0f, 0xb0);
  write_i2c(0x38, 0x13, 0x04);
  write_i2c(0x36, 0x18, 0x04);
  write_i2c(0x36, 0x12, 0x4b);
  write_i2c(0x37, 0x08, 0x64);
  write_i2c(0x37, 0x09, 0x12);
  write_i2c(0x37, 0x0c, 0x00);
  write_i2c(0x3a, 0x02, 0x07);
  write_i2c(0x3a, 0x03, 0xb0);
  write_i2c(0x3a, 0x0e, 0x06);
  write_i2c(0x3a, 0x0d, 0x08);
  write_i2c(0x3a, 0x14, 0x07);
  write_i2c(0x3a, 0x15, 0xb0);
  write_i2c(0x40, 0x01, 0x02);
  write_i2c(0x40, 0x04, 0x06);
  write_i2c(0x30, 0x02, 0x00);
  write_i2c(0x30, 0x06, 0xff);
  ...
  write_i2c(0x50, 0x01, 0x83);
  write_i2c(0x30, 0x36, 0x69);
  write_i2c(0x30, 0x35, 0x31);
  write_i2c(0x40, 0x05, 0x1A);
}
...
void ov5640_c_simple_awb(void) { // XXX: UNTESTED
  write_i2c(0x51, 0x83, 0x80);   // Simple AWB, 0 for advanced AWB
}

void ov5640_c_quality_high(void) { // XXX: UNTESTED
  write_i2c(0x44, 0x07, 0x02);
}
void ov5640_c_quality_def(void) { // XXX: UNTESTED
  write_i2c(0x44, 0x07, 0x04);
}
void ov5640_c_quality_low(void) { // XXX: UNTESTED
  write_i2c(0x44, 0x07, 0x08);
}
...
void ov5640_test_fun(void) {
  ...
  // write_i2c(0x53, 0x84, 0xFF); //slight increase
  //  write_i2c(0x53, 0x85, 0x7e);
  write_i2c(0x53, 0x86, 0xFF);
  /*
  write_i2c(0x53, 0x81, 0x1e);
  write_i2c(0x53, 0x82, 0x5b);
  write_i2c(0x53, 0x83, 0x08);
...
// NOTE: Needs to be placed after the resolution configuration
void ov5640_c_advanced_awb(void) {
  write_i2c(0x34, 0x06, 0x00);
  write_i2c(0x51, 0x92, 0x04);
  write_i2c(0x51, 0x91, 0xf8);
  write_i2c(0x51, 0x94, 0xf0);
  write_i2c(0x51, 0x95, 0xf0);
  write_i2c(0x51, 0x8d, 0x3d);
  write_i2c(0x51, 0x8f, 0x54);
  write_i2c(0x51, 0x8e, 0x3d);
  write_i2c(0x51, 0x90, 0x54);
  write_i2c(0x51, 0x8b, 0xa8);
  write_i2c(0x51, 0x8c, 0xa8);
  write_i2c(0x51, 0x87, 0x18);
  write_i2c(0x51, 0x88, 0x18);
  write_i2c(0x51, 0x89, 0x6e);
  write_i2c(0x51, 0x8a, 0x68);
  write_i2c(0x51, 0x86, 0x1c);
  write_i2c(0x51, 0x81, 0x50);
  write_i2c(0x51, 0x84, 0x25);
  write_i2c(0x51, 0x82, 0x11);
  write_i2c(0x51, 0x83, 0x14);
  write_i2c(0x51, 0x84, 0x25);
  write_i2c(0x51, 0x85, 0x24);
}
